              ...
              <form className="aj-form">
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="aj-section-desc" style={styles.sectionDesc}>
                        📝 Basic details about the company and the role
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="aj-grid-2" style={styles.grid2}>
                    <div className="aj-input-wrapper">
                      ...
                      <select
                        className="aj-select aj-readonly"
                        disabled
                        required
                        style={styles.select}
                      >
                  ...
                  <div
                    className="aj-highlight-box mt-4"
                    style={styles.highlightBox}
                  >
                    <label className="aj-label" style={styles.label}>
                      ✏️ Job Title *{" "}
                      <span
                        className="aj-hint-inline"
                        style={styles.hintInline}
                      >
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="aj-section-desc" style={styles.sectionDesc}>
                        🎓 Academic background and communication skills
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="aj-grid-1">
                    <div className="aj-input-wrapper mb-4">
                      ...
                      <div
                        className="aj-card-grid aj-card-grid-4"
                        style={styles.cardGrid4}
                      >
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="aj-section-desc" style={styles.sectionDesc}>
                        📍 Where and how will the candidate work?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="aj-grid-2" style={styles.grid2}>
                    ...
                    <div className="aj-input-wrapper">
                      ...
                      <div
                        className="aj-card-grid aj-card-grid-2"
                        style={styles.cardGrid2}
                      >
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="aj-section-desc" style={styles.sectionDesc}>
                        ⚡ Special skills or tools knowledge
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="aj-skill-section">
                    ...
                    <div className="aj-suggestions mt-3">
                      <span className="aj-hint-text" style={styles.hintText}>
                        Suggestions:
                      </span>
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  <div className="aj-salary-cards" style={styles.salaryCards}>
                    {/* Minimum Salary Card */}
                    <div
                      className="aj-salary-card aj-salary-min"
                      style={styles.salaryCard}
                    >
                      <div
                        className="aj-salary-card-icon"
                        style={styles.salaryCardIcon}
                      >
                        📉
                      </div>
                      <div className="aj-salary-card-content">
                        <div
                          className="aj-salary-card-title"
                          style={styles.salaryCardTitle}
                        >
                          Minimum Salary
                        </div>
                        <div
                          className="aj-salary-card-hint"
                          style={styles.salaryCardHint}
                        >
                          Lowest salary offered
                        </div>
                        <div
                          className="aj-salary-input-wrap"
                          style={styles.salaryInputWrap}
                        >
                          <span
                            className="aj-salary-prefix"
                      ...
                      <div
                        className="aj-salary-card-glow aj-glow-blue"
                        style={{
                          ...styles.salaryCardGlow,
                          background: "#3b82f6",
                        }}
                      ></div>
                    </div>
                    ...
                    {/* Maximum Salary Card */}
                    <div
                      className="aj-salary-card aj-salary-max"
                      style={styles.salaryCard}
                    >
                      <div
                        className="aj-salary-card-icon"
                      ...
                      <div
                        className="aj-salary-card-glow aj-glow-purple"
                        style={{
                          ...styles.salaryCardGlow,
                          background: "#8b5cf6",
                        }}
                    ...
                    {/* Commission Card */}
                    <div
                      className="aj-salary-card aj-salary-commission"
                      style={{ ...styles.salaryCard, ...styles.commissionCard }}
                    >
                      <div
                        className="aj-salary-card-icon"
                        style={styles.salaryCardIcon}
                      ...
                      <div
                        className="aj-salary-card-glow aj-glow-green"
                        style={{
                          ...styles.salaryCardGlow,
                          background: "#10b981",
                        }}
                  ...
                  {/* Salary Preview */}
                  <div
                    className="aj-salary-preview mt-3"
                    style={styles.salaryPreview}
                  >
                    <span
                      className="aj-salary-preview-label"
                      style={styles.salaryPreviewLabel}
                    >
                      👁️ Preview:
                    </span>
                    <span
                      className="aj-salary-preview-value"
                      style={styles.salaryPreviewValue}
                    >
                      Range: ₹{formData.salaryMin} - ₹{formData.salaryMax} LPA +{" "}
                      {formData.commission || "Commission"} (Commission)
                    </span>
                  </div>
                </div>
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="aj-section-desc" style={styles.sectionDesc}>
                        🎯 What goals and perks come with this job?
                      </p>
                    </div>
                  </div>
                ...
                <div className="aj-section-group" style={styles.sectionGroup}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="aj-section-desc" style={styles.sectionDesc}>
                        📄 Full details about duties and requirements
                      </p>
                    </div>
                  </div>
                ...
                <div className="aj-footer" style={styles.footer}>
                  ...
                  <div className="aj-footer-right">
                    <button
                      type="button"
                      className="aj-btn aj-btn-discard"
...
const styles = {
  ...
  commissionCard: {
    background:
      "linear-gradient(135deg, rgba(251,191,36,0.05), rgba(245,158,11,0.08))",
