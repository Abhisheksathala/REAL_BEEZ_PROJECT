...
const CreateJobModalNormal = ({ isOpen , onClose }) => {
  const [formData, setFormData] = useState({
    ...
    salaryMax: '',
    commission: '',
    salesTargets: 'Performance Based',
    description: ''
  });
  ...
  const languageOptions = [
    ...
    'മലയാളം', 'मराठी', 'বাংলা', 'ગુજરાતી', 'ਪੰਜਾਬੀ', 'ଓଡ଼ିଆ', 'اردو'
  ];

  const experienceOptions = [
    'Beginner (0-1 Year)', '1-3 Years', '3-5 Years', 
  ...
  const salesTargetOptions = [
    'Performance Based', 'Monthly Targets', 'Weekly Targets', 'KPI Based'
  ];

  const benefitsOptions = [
    'Performance Bonus', 'PF', 'Insurance', 'Cell Phone Reimbursement'
  ];

  const jobRoleOptions = [
    'Office Based', 'Hybrid', 'Site Based', 'Channel Sales'
  ];
    ...
    <div className="vj-modal-overlay" style={styles.overlay}>
      <div className="vj-modal-content vj-modal-lg" style={styles.modal}>
        ...
        <div className="vj-modal-header" style={styles.header}>
          <div>
            <h5 className="fw-bold mb-0" style={styles.headerTitle}>
              <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="18" width="18" xmlns="http://www.w3.org/2000/svg" style={styles.headerIcon}>
                <line x1="12" y1="5" x2="12" y2="19"></line>
                <line x1="5" y1="12" x2="19" y2="12"></line>
              </svg>
              Create New Job
            </h5>
            <p className="mb-0" style={styles.headerSubtitle}>
          ...
          <div className="aj-root" style={styles.ajRoot}>
            <form className="aj-form" onSubmit={handleSubmit}>
              ...
              <div className="aj-section-group" style={styles.sectionGroup}>
                ...
                <div className="aj-grid-2" style={styles.grid2}>
                  <div className="aj-input-wrapper">
                    ...
                    <p className="aj-auto-hint mt-1" style={styles.autoHint}>
                  ...
                  <div className="aj-input-wrapper">
                    ...
                    <div className="aj-input-wrapper mt-3">
                      ...
                      <select 
                        ...
                        style={styles.select}
                      >
                        <option value="">{formData.location ? 'Select Area' : 'Select city first'}</option>
              ...
              <div className="aj-section-group" style={styles.sectionGroup}>
                ...
                {/* Salary Preview */}
                {(formData.salaryMin || formData.salaryMax || formData.commission) && (
                  <div className="aj-salary-preview mt-3" style={styles.salaryPreview}>
                    ...
                    <span className="aj-salary-preview-value" style={styles.salaryPreviewValue}>
                      {formData.salaryMin && formData.salaryMax 
                        ...
                        : formData.salaryMin 
                          ? `From ₹${formData.salaryMin} LPA` 
                          : formData.salaryMax 
                            ? `Up to ₹${formData.salaryMax} LPA` 
                            : ''}
                      {formData.commission && ` + ${formData.commission} (Commission)`}
                    </span>
                  </div>
                )}
              </div>
                  ...
                  <div className="aj-input-wrapper">
                    ...
                    <div className="aj-card-grid aj-card-grid-2" style={styles.cardGrid2}>
                      {benefitsOptions.map(benefit => (
                        <div 
                          key={benefit}
                          className={`aj-card-option ${selectedBenefits.includes(benefit) ? 'aj-card-selected' : ''}`} 
                          style={styles.cardOption}
              ...
              <div className="aj-footer" style={styles.footer}>
                ...
                <div className="aj-footer-right">
                  <button type="button" className="aj-btn aj-btn-discard" style={{ ...styles.btn, ...styles.btnDiscard }} onClick={handleDiscard}>
                    Discard
                  </button>
                  <button type="button" className="aj-btn aj-btn-outline" style={{ ...styles.btn, ...styles.btnOutline }} onClick={onClose}>
                    Cancel
                  </button>
                  <button type="submit" className="aj-btn aj-btn-submit" style={{ ...styles.btn, ...styles.btnSubmit }}>
                    Create Job
                  </button>
                </div>
              </div>
...
styleSheet.textContent = `
  ...
  .aj-card-selected {
    ...
    box-shadow: inset 3px 3px 6px #d1d9e6, inset -3px -3px 6px #ffffff, 0 10px 20px rgba(79, 70, 229, 0.05) !important;
  }
  ...
  .aj-input:focus, .aj-textarea:focus {
    box-shadow: inset 6px 6px 12px #d1d9e6, inset -6px -6px 12px #ffffff, 0 0 0 2px rgba(79, 70, 229, 0.1);
  }
  ...
  @media (max-width: 480px) {
    ...
    .aj-card-grid-4 { grid-template-columns: 1fr; }
  }
`;
document.head.appendChild(styleSheet);

export default CreateJobModalNormal;